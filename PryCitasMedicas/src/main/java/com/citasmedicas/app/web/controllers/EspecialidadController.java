...
public class EspecialidadController {
	...
	@PostMapping("/form")
	public String save(@Valid Especialidad especialidad,BindingResult result, RedirectAttributes flash, Model model,SessionStatus sesion ){ 
		try {
			if(result.hasErrors()) {
				model.addAttribute("title","Registro de Especialidad");
				return "especialidad/form";
			}
